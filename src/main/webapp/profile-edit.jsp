...
<body>
    ...
    <div class="col-md-8 col-xs-12">
        <div class="white-box">
            <form class="form-horizontal form-material" action="${pageContext.request.contextPath}/profile-edit" method="POST">
                <input type="hidden" name="idTask" value="${taskInfor.taskId}">
            
    <div class="form-group">
        <label class="col-md-12">Tên dự án</label>
        <div class="col-md-12">
            <input type="text" readonly value="${taskInfor.jobName != null ? taskInfor.jobName : 'Không có thông tin'}" class="form-control form-control-line">
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-12">Tên công việc</label>
        <div class="col-md-12">
            <input type="text" readonly value="${taskInfor.taskName != null ? taskInfor.taskName : 'Không có thông tin'}" class="form-control form-control-line">
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-12">Ngày bắt đầu</label>
        <div class="col-md-12">
            <input type="text" readonly value="${taskInfor.taskStartDate != null ? taskInfor.taskStartDate : 'Không có thông tin'}" class="form-control form-control-line">
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-12">Ngày kết thúc</label>
        <div class="col-md-12">
            <input type="text" readonly value="${taskInfor.taskEndDate != null ? taskInfor.taskEndDate : 'Không có thông tin'}" class="form-control form-control-line">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-md-12">
            <select class="form-control form-control-line" name="status">
                <c:forEach var="status" items="${status}">
                    <option value="${status.idStatus}">${status.nameStatuString}</option>
                </c:forEach>                                        
            </select>
        </div>
    </div>
