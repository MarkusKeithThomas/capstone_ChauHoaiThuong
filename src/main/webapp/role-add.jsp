                        ...
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="POST">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="nameRole" placeholder="Tên quyền"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="descriptionRole" placeholder="Mô tả" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">Add Role</button>
                                        <a href="${pageContext.request.contextPath}/role-table" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
