                                    ...
                                    <tbody>
                                     <!-- Vòng lặp để hiển thị danh sách members từ cơ sở dữ liệu -->
                                        <c:forEach var="jobs" items="${jobs}">
                                            <tr>
                                                <td>${jobs.idJob}</td>
                                                <td>${jobs.nameJob}</td> <!-- Hiển thị fullName -->
                                                <td>${jobs.startDateJob}</td> <!-- Hiển thị username (email) -->
            									<td>${jobs.endDateJob}</td> <!-- Hiển thị phone -->
                                                <td>
                                                    <a href="#" class="btn btn-sm btn-primary">Sửa</a>
													<form action="${pageContext.request.contextPath}/groupwork"
