            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <form class="form-horizontal form-material" method="post" action="${pageContext.request.contextPath}/task-add">
                                <div class="form-group">
                                    <label class="col-md-12">Dự án</label>
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="jobId">
                                         <c:forEach var="jobs" items="${jobs}">
        										<option value="${jobs.idJob}">${jobs.nameJob}</option>
                                        </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="nameJob" placeholder="Tên công việc"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" name="datestart" placeholder="dd/MM/yyyy"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="date" name="dateend" placeholder="dd/MM/yyyy"
                                            class="form-control form-control-line" required> 
                                    </div>
                                </div>
                                <div class="form-group">
